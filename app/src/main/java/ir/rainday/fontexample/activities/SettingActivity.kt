...
class SettingActivity : BaseActivity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val selectedIndex = if (selectedFont == null) 0 else if (selectedFont == "Exo") 1 else 2
    ...
    override fun onItemSelected(p0: AdapterView<*>?, p1: View?, position: Int, p3: Long) {
        ...
        else if (selected == "Exo" && currentFont?.familyName != "Exo") {
            FontManager.getInstance().currentFont = MyApp.exo
            restart()
        }
        else if (selected == "Taviraj" && currentFont?.familyName != "Taviraj") {
